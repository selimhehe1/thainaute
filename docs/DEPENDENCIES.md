...
Dernière vérification : 13 août 2026. Les versions sont exactes dans chaque
...
| @axe-core/playwright 4.13.0     | Porte WCAG 2.2 AA sur huit écrans et trois largeurs             | MPL-2.0 ; test uniquement                 | Lighthouse mesure une page à la fois sans devenir une porte de fusion ; un audit manuel n'est pas rejouable |
